...
function query() {
    ...
    utilService.loadFromStorage(BOOKS_KEY);
...
function addReview(bookId, review) {
    var book = storageService.get(BOOKS_KEY, bookId);
...
//`````````````````````````` sync storage system ... changed into async
// export const bookService = {
//     query,
//     remove,
//     save,
...
//         books = [];
//         books.push(_createBook('metus hendrerit', "mi est eros convallis auctor arcu dapibus himenaeos", ["Barbara Cartland"], 2008, "placerat nisi sodales suscipit tellus tincidunt mauris elit sit luctus interdum ad dictum platea vehicula conubia fermentum habitasse congue suspendisse", 253, ["Computers", "Hack"], "http://coding-academy.org/books-photos/1.jpg", "en", 20, "NIS", false));
//         books.push(_createBook("morbi", "mi est eros convallis auctor arcu dapibus himenaeos", ["Barbara Cartland"], 2019, "placerat nisi sodales suscipit tellus tincidunt mauris elit sit luctus interdum ad dictum platea vehicula conubia fermentum habitasse congue suspendisse", 713, ["Computers", "Hack"], "http://coding-academy.org/books-photos/2.jpg", "en", 109, "EUR", false));
//         books.push(_createBook('hendrerit', "mi est eros convallis auctor arcu dapibus himenaeos", ["Barbara Cartland"], 2016, "placerat nisi sodales suscipit tellus tincidunt mauris elit sit luctus interdum ad dictum platea vehicula conubia fermentum habitasse congue suspendisse", 92, ["Computers", "Hack"], "http://coding-academy.org/books-photos/3.jpg", "en", 40, "USD", false));
//         books.push(_createBook('metus', "mi est eros convallis auctor arcu dapibus himenaeos", ["Barbara Cartland"], 1989, "placerat nisi sodales suscipit tellus tincidunt mauris elit sit luctus interdum ad dictum platea vehicula conubia fermentum habitasse congue suspendisse", 564, ["Computers", "Hack"], "http://coding-academy.org/books-photos/4.jpg", "en", 50, "EUR", false));
//         utilService.saveToStorage(BOOKS_KEY, books);
//     }
//     return books;
// }

// function _createBook(title = '', subtitle = '', authors = [], publishDate = '', description = '', pageCount = 0, categories = [], thumbnail = '', language = 'en', priceAmount = 0, priceCurrency = ILS, isOnSale = false) {
//     const book = {
